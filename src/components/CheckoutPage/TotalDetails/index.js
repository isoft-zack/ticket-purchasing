...
const TotalDetails = ({ quantity, setMessage }) => {
  ...
  return (
    <div className="total_details_container total_bill_container">
      ...
      <label className="internal_details">
        <div>
          xfr XFER Proof of as least one dose of COVID-19 vaccination for ages 5
          to 11 and guests ages 12 and up will be required to show proof of two
          COVID-19 vaccine does or one dose of the Johnson & Johnson vaccine.
        </div>
